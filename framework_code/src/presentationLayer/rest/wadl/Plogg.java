...
/**
 * Restlet Resource to invoke WADL Service Description file for Plogg Smart Meter.
 * 
 * @author kami
 * 
 */
public class Plogg extends AbstractResource {
	 ...
	 */
	public Plogg(Context context, Request request,
			Response response) {
	...
	public void handleEveryting() throws IOException {
		...
		String filename = "wadl/plogg.wadl";
