...
/**
 * Restlet Resource to invoke WADL Service Description file for Contiki.
 * 
 * @author kami
 * 
 */
public class Contiki extends AbstractResource {
	 ...
	 */
	public Contiki(Context context, Request request,
			Response response) {
	...
	public void handleEveryting() throws IOException {
		...
		String filename = "wadl/contiki.wadl";
